...
const Animations = () => {
  const storiesData = {
    ...
    '6-7': [
      ...
      { id: 10, title: 'THE LITTLE RED HEN', videoUrl: '/videos/6-7/thelittleredhen.mp4' },
      { id: 11, title: 'CHICKEN LITTLE', videoUrl: '/videos/6-7/chickenlittle.mp4' },
      { id: 12, title: 'THE BIRD AND THE WHALE', videoUrl: '/videos/6-7/thebirdandthewale.mp4' },
    ],
    '8-10': [
